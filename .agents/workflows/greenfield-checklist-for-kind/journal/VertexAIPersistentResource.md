...
## Current Step
**Step 1: Direct API Types and Identity and Reference Types Pattern** (Rebased and force-pushed to resolve type mismatch failures; new CI check-runs are currently in progress)
