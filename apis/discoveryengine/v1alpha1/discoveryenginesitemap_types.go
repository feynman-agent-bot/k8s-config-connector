...
type DiscoveryEngineSitemapSpec struct {
	// The DataStore this sitemap should be part of.
	// +required
	DataStoreRef *DiscoveryEngineDataStoreRef `json:"dataStoreRef"`

	// The DiscoveryEngineSitemap name/id. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`

	// Required. Public URI for the sitemap, e.g. `www.example.com/sitemap.xml`.
	// +required
